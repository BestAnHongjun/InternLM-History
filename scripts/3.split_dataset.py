...
if __name__ == "__main__":
    path = os.path.join("datasets", "2022_junior_middle_history.json")
    train_path = os.path.join("datasets", "2022_junior_middle_history_train.json")
    test_path = os.path.join("datasets", "2022_junior_middle_history_test.json")
    split_conversations(path, train_path, test_path)
